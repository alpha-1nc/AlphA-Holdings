...
import { getReportBySlugMerged } from "@/lib/analysis-reports-data";
...
export default async function AnalysisReportViewerPage(props: {
    ...
    const { year, month, slug } = await props.params;

    const report = await getReportBySlugMerged(year, month, slug);
